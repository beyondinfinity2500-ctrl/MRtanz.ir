      ...
      <div className="space-y-6 mt-6">
        <section className="card p-5">
          <p className="text-surface-700 text-sm leading-relaxed">
            ...
            <strong>سایت مستر طنز</strong> اومدیم تا از اهمیت خنده بر جسم و روح و روان
            بگیم. اونم در عمل. یعنی با کلیپ‌های طنز و خنده‌دار و گاهی تو فکر بر...
            پس لطفاً www.MrTanz.ir رو از یاد نبرید تا خنده از یادتون نره!
          </p>
        </section>

        <section className="card p-5">
          <h2 className="font-bold text-surface-800 mb-3">ماموریت مستر طنز</h2>
          <p className="text-surface-700 text-sm leading-relaxed">
        ...
        <section className="card p-5">
          <h2 className="font-bold text-surface-800 mb-3">اهمیت خندیدن در زندگی</h2>
          <p className="text-surface-700 text-sm leading-relaxed">
            شادی و شاد بودن بهترین داروی بی‌ضرر برای مغزه. استرس، وسواس فکری و
            نشخوار فکری باعث می‌شه ذهن مریض و افسرده بشه. اگه اهمیت خنده و شادی رو
