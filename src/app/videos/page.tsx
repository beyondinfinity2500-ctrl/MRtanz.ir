...
import { videos, getVideoCategories } from "@/data/videos";
    ...
    <div className="container-main py-8 md:py-12">
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-text-primary text-sm font-medium">ویدیوها</span>
        </div>
        <h1 className="text-3xl sm:text-4xl font-extrabold text-text-primary mb-3">ویدیوها</h1>
        <p className="text-text-secondary text-sm sm:text-base max-w-2xl">
          تمام کلیپ‌های طنز، استندآپ کمدی، دوبله و کلیپ‌های خنده‌دار مستر طنز
        </p>
      </div>
      ...
      {filteredVideos.length > 0 ? (
        ...
        <div className="text-center py-16">
          ...
          <h3 className="text-lg font-bold text-text-primary mb-2">ویدیویی یافت نشد</h3>
          <p className="text-text-muted text-sm mb-4">در این دسته‌بندی ویدیویی موجود نیست</p>
          <Link
            href="/videos/"
